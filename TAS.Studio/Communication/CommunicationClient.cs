...
public static class CommunicationClient {
            ...
            OnReceived = c => {
                ...
                switch (gameToStudioMessage) {
                    ...
                    case UpdateTextsMessage updateTextsMessage:
                        ...
                        break;
                    case ReturnGameDataMessage returnGameDataMessage:
                        ReceiveReturnDataMessage(returnGameDataMessage);
                        break;
                }
            },
    ...
    private static void ReceiveHotkeySettingsMessage(HotkeySettingsMessage hotkeySettingsMessage) {
        CommunicationWrapper.SetBindings(
            hotkeySettingsMessage.Settings.ToDictionary(pair => (HotkeyID) pair.Key, pair => pair.Value.Cast<KeyCodes>().ToList()));
    }
    ...
    private static void ReceiveReturnDataMessage(ReturnGameDataMessage returnGameDataMessage) {
        CommunicationWrapper.ReturnData = returnGameDataMessage.Data;
    }
}