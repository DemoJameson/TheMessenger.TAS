...
public abstract class Themes {
    ...
    public abstract List<string> Lable { get; set; }
    ...
    public static void ResetThemes() {
        ...
        SyntaxHighlighter.LabelStyle = ColorUtils.CreateTextStyle(themes.Lable);
...
public class LightThemes : Themes {
    ...
    public override List<string> Lable { get; set; } = new() {"4682B4"};
...
public class DarkThemes : Themes {
    ...
    public override List<string> Lable { get; set; } = new() {"5599CC"};
...
public class CustomThemes : Themes {
    ...
    public override List<string> Lable { get; set; } = new() {"268BD2"};
